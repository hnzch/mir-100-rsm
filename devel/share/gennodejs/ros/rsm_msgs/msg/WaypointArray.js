...
class WaypointArray {
  constructor(initObj={}) {
    if (initObj === null) {
      ...
      if (initObj.hasOwnProperty('waypoints_size')) {
        this.waypoints_size = initObj.waypoints_size
      }
      else {
        this.waypoints_size = 0;
      }
    }
  }
  ...
  static serialize(obj, buffer, bufferOffset) {
    ...
    // Serialize message field [waypoints_size]
    bufferOffset = _serializer.int32(obj.waypoints_size, buffer, bufferOffset);
    return bufferOffset;
  }
  ...
  static deserialize(buffer, bufferOffset=[0]) {
    ...
    // Deserialize message field [waypoints_size]
    data.waypoints_size = _deserializer.int32(buffer, bufferOffset);
    return data;
  }
  ...
  static Resolve(msg) {
    ...
    if (msg.waypoints_size !== undefined) {
      resolved.waypoints_size = msg.waypoints_size;
    }
    else {
      resolved.waypoints_size = 0
    }
